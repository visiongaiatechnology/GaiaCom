...
async function run() {
  ...
  const appMainContentSource = fs.readFileSync(path.join(__dirname, 'components', 'app', 'AppMainContent.js'), 'utf8');
  const authScreenSource = fs.readFileSync(path.join(__dirname, 'components', 'auth', 'AuthScreen.js'), 'utf8');
  const securityCenterSource = fs.readFileSync(path.join(__dirname, 'components', 'chat', 'SecurityCenter.js'), 'utf8');
  const chatPaneSource = fs.readFileSync(path.join(__dirname, 'components', 'chat', 'ChatPane.js'), 'utf8');
  const publicChannelsPaneSource = fs.readFileSync(path.join(__dirname, 'components', 'chat', 'PublicChannelsPane.js'), 'utf8');

...
def run_poc():
    ...
    dialog = read_text(root / "Frontend" / "frontend" / "src" / "components" / "common" / "HumanProofDialog.jsx")
    passport = read_text(root / "Frontend" / "frontend" / "src" / "components" / "common" / "GaiaPassportCard.jsx")
    crypto = read_text(root / "Frontend" / "frontend" / "src" / "crypto.js")
    gsn = read_text(root / "Frontend" / "frontend" / "src" / "components" / "chat" / "GsnPane.jsx")
    security_center = read_text(root / "Frontend" / "frontend" / "src" / "components" / "chat" / "SecurityCenter.jsx")
    contact_modal = read_text(root / "Frontend" / "frontend" / "src" / "components" / "modals" / "ContactProfileModal.jsx")

...
def run_poc():
    ...
    assert_contains(extreme_runner_text, '"go", "build", "-buildvcs=false", "-trimpath"', "extreme_runner", failures)
    assert_contains(extreme_runner_text, "tempfile.gettempdir()", "extreme_runner", failures)
    assert_not_contains(extreme_runner_text, 'binary_name = "gaiacom-backend.exe"', "extreme_runner", failures)

    assert_contains(master_suite_text, '"go", "build", "-buildvcs=false", "-trimpath"', "master_security_suite", failures)
    assert_contains(master_suite_text, "tempfile.gettempdir()", "master_security_suite", failures)

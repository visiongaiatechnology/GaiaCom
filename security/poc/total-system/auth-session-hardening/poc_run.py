...
def run_poc():
    ...
    profile_pane = read_text(root / "Frontend" / "frontend" / "src" / "components" / "chat" / "ProfilePane.jsx")
    unlock_screen = read_text(root / "Frontend" / "frontend" / "src" / "components" / "auth" / "UnlockScreen.jsx")
